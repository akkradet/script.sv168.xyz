...
Install_rsync()
{
	...
	wget -O $pluginPath/rsync_main.so http://script.sv168.xyz/install/plugin/rsync_en/rsync_main.so -T 5
	wget -O $pluginPath/rsync_main.cpython-36m-x86_64-linux-gnu.so http://script.sv168.xyz/install/plugin/rsync_en/rsync_main.cpython-36m-x86_64-linux-gnu.so -T 5
	wget -O $pluginPath/rsync_main.cpython-37m-x86_64-linux-gnu.so http://script.sv168.xyz/install/plugin/rsync_en/rsync_main.cpython-37m-x86_64-linux-gnu.so -T 5

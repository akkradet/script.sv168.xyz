...
Install()
{
	...
	if [ "$?" -ne 0 ];then
		...
		wget -O $install_path/pgsql_manager_main.py $download_url/install/plugin/pgsql_manager_en/pgsql_manager_main.py -T 20
		wget -O $install_path/index.html $download_url/install/plugin/pgsql_manager_en/index.html -T 20
		wget -O $install_path/info.json $download_url/install/plugin/pgsql_manager_en/info.json -T 20
		wget -O $install_path/icon.png $download_url/install/plugin/pgsql_manager_en/icon.png -T 20
		wget -O $install_path/pgsql_install.sh $download_url/install/plugin/pgsql_manager_en/pgsql_install.sh -T 20
		wget -O $install_path/pgsql.sh $download_url/install/plugin/pgsql_manager_en/pgsql.sh -T 20
	fi
	#文件下载结束
	#==================================================================
